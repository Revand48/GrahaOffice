<section class="py-14 bg-gradient-section">
    ...
    <div class="grid gap-10 md:grid-cols-3">
      ...
      >
        ...
        <div class="flex flex-col flex-grow p-6">
          <h3 class="text-lg font-semibold mb-1 h-[56px] overflow-hidden">Kerja Fleksibel, Produktivitas Maksimal: Begini Caranya!</h3>
      ...
      >
        ...
        <div class="flex flex-col flex-grow p-6">
          <h3 class="text-lg font-semibold mb-1 h-[56px] overflow-hidden">Kesan Pertama yang Profesional? Mulai dari Virtual Office Graha Office Surabaya</h3>
          <p class="mb-3 text-sm text-gray-500">Sumber: grahaoffice.com</p>
          <p class="flex-grow mb-6 text-gray-600 line-clamp-5">
      ...
      >
        ...
        <div class="flex flex-col flex-grow p-6">
          <h3 class="text-lg font-semibold mb-1 h-[56px] overflow-hidden">Keuntungan Sewa Virtual Office di Graha Office Surabaya untuk Pebisnis Modern</h3>
          <p class="mb-3 text-sm text-gray-500">Sumber: grahaoffice.com</p>
          <p class="flex-grow mb-6 text-gray-600 line-clamp-5">
