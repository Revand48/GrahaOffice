...
<div class="min-h-screen px-4 py-10 mt-1 bg-gray-50 md:px-16">

  <div class="relative p-1 mb-10 transition-all duration-300 ease-out bg-white rounded-lg shadow-sm hover:shadow-md focus-within:shadow-lg">
    <div class="flex items-center gap-3 px-4 py-2">
      ...
      <select id="searchType" class="text-gray-700 transition-colors duration-300 bg-transparent border-b-2 border-transparent cursor-pointer focus:outline-none focus:ring-0 focus:border-orange-400">
  ...
  <div id="jobList" class="space-y-8">
    ...
    <div class="p-6 bg-white rounded-lg shadow-md" data-profession="digital marketing" data-location="surabaya office" data-type="internship">
      <div class="flex items-center gap-4">
        ...
        <div class="flex-1">
          <h2 class="text-xl font-bold text-gray-800">Digital Marketing</h2>
      ...
      <div class="grid grid-cols-1 gap-4 mt-4 text-sm font-medium text-gray-700 md:grid-cols-4">
        <div>
          <p class="text-gray-400">Posisi</p>
      ...
      <div id="details-0" class="hidden p-4 mt-6 border border-gray-200 rounded bg-gray-50">
        <p class="mb-2 font-semibold text-gray-700">Syarat:</p>
    ...
    <div class="p-6 bg-white rounded-lg shadow-md" data-profession="cleaning service" data-location="yogyakarta office" data-type="full time">
      <div class="flex items-center gap-4">
        <div class="p-3 bg-blue-100 rounded-full">
          <svg class="w-8 h-8 text-blue-500" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" d="M11 17l-5-5m0 0l5-5m-5 5h12" />
        ...
        <div class="flex-1">
          <h2 class="text-xl font-bold text-gray-800">Cleaning Service</h2>
      ...
      <div id="details-1" class="hidden p-4 mt-6 border border-gray-200 rounded bg-gray-50">
        <p class="mb-2 font-semibold text-gray-700">Syarat:</p>
        <ul class="space-y-1 text-sm text-gray-600 list-disc list-inside">
