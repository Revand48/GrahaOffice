<section class="py-14 bg-gradient-section dark:bg-slate-900 dark:text-slate-100">
  <div class="px-6 mx-auto max-w-7xl">
    ...
    >
      <h2 class="text-3xl font-bold leading-tight font-pj sm:text-4xl xl:text-5xl">
        ...
        <span class="text-gray-900 dark:text-slate-100"> & </span>
        <span class="inline-block text-transparent bg-gradient-to-r from-yellow-400 to-yellow-600 bg-clip-text animate-pulse">
          Berita
        </span>
      </h2>
    ...
    <div class="grid gap-10 md:grid-cols-3">
      ...
      <div
        data-animate="card1"
        class="relative flex flex-col overflow-hidden transition-all duration-[2000ms] ease-out
               bg-white dark:bg-slate-800 border border-transparent dark:border-slate-700
               rounded-lg opacity-0 -translate-x-full"
      >
        <img src="https://grahaoffice.com/wp-content/uploads/2025/08/tempImagewucVQm-980x653.jpeg"
             alt="Berita 1"
             class="object-cover w-full h-56 rounded-t-lg">
        <div class="flex flex-col flex-grow p-6">
          <h3 class="text-lg font-semibold mb-1 h-[56px] overflow-hidden text-gray-900 dark:text-slate-100">
            Kerja Fleksibel, Produktivitas Maksimal: Begini Caranya!
          </h3>
          <p class="mb-3 text-sm text-gray-500 dark:text-slate-400">Sumber: grahaoffice.com</p>
          <p class="flex-grow mb-6 text-gray-600 dark:text-slate-300 line-clamp-5">
          ...
          <a href="https://grahaoffice.com/blog/kerja-fleksibel-produktivitas/"
             target="_blank"
             class="inline-block font-semibold text-yellow-600 hover:underline">
            Baca Selengkapnya →
          </a>
        </div>
      </div>
      ...
      <div
        ...
        class="relative flex flex-col overflow-hidden transition-all duration-[2000ms] ease-out
               bg-white dark:bg-slate-800 border border-transparent dark:border-slate-700
               rounded-lg opacity-0 translate-y-full"
      >
        <img src="https://grahaoffice.com/wp-content/uploads/2025/08/group-people-working-out-business-plan-office.jpg"
             alt="Berita 2"
             class="object-cover w-full h-56 rounded-t-lg">
        <div class="flex flex-col flex-grow p-6">
          <h3 class="text-lg font-semibold mb-1 h-[56px] overflow-hidden text-gray-900 dark:text-slate-100">
            Kesan Pertama yang Profesional? Mulai dari Virtual Office Graha Office Surabaya
          </h3>
          <p class="mb-3 text-sm text-gray-500 dark:text-slate-400">Sumber: grahaoffice.com</p>
          <p class="flex-grow mb-6 text-gray-600 dark:text-slate-300 line-clamp-5">
          ...
          <a href="https://grahaoffice.com/blog/kesan-profesional-mulai-dari-virtual-office/"
             target="_blank"
             class="inline-block font-semibold text-yellow-600 hover:underline">
            Baca Selengkapnya →
          </a>
      ...
      <div
        ...
        class="relative flex flex-col overflow-hidden transition-all duration-[2000ms] ease-out
               ...
               rounded-lg opacity-0 translate-x-full"
      >
        <img src="https://grahaoffice.com/wp-content/uploads/2025/08/empty-room-with-chairs-desks-1-980x654.jpg"
             alt="Berita 3"
             class="object-cover w-full h-56 rounded-t-lg">
        <div class="flex flex-col flex-grow p-6">
          <h3 class="text-lg font-semibold mb-1 h-[56px] overflow-hidden text-gray-900 dark:text-slate-100">
            Keuntungan Sewa Virtual Office di Graha Office Surabaya untuk Pebisnis Modern
          </h3>
          <p class="mb-3 text-sm text-gray-500 dark:text-slate-400">Sumber: grahaoffice.com</p>
          <p class="flex-grow mb-6 text-gray-600 dark:text-slate-300 line-clamp-5">
          ...
          <a href="https://grahaoffice.com/blog/keuntungan-sewa-virtual-office-surabaya"
             target="_blank"
             class="inline-block font-semibold text-yellow-600 hover:underline">
            Baca Selengkapnya →
          </a>
