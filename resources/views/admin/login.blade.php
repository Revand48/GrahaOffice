...
<body class="antialiased text-gray-800">
    <section class="relative flex items-center justify-center h-screen overflow-hidden">
        ...
        <img src="{{ asset('images/bgadmin.jpg') }}" alt="Office" class="absolute inset-0 object-cover w-full h-full">
        <!-- Overlay kuning -->
        <div class="absolute inset-0 bg-overlay"></div>

        <!-- Card login -->
        <div class="relative z-10 w-full max-w-sm p-8 shadow-xl bg-white/90 backdrop-blur rounded-2xl animate-fadeIn">
            <!-- Icon SVG Dashboard -->
            ...
            <h1 class="mb-6 text-xl font-bold text-center text-gray-700">Dashboard Admin</h1>
            ...
            <form action="{{ route('login') }}" method="POST">
                ...
                <div class="mb-5">
                    ...
                    <input id="username" name="username" type="text" required
                        class="w-full px-4 py-2 transition border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-400">
                </div>
