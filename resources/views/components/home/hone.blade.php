<section class="relative overflow-hidden text-gray-800 bg-white dark:bg-slate-900 dark:text-slate-100"
         x-data="{ show: false }"
  ...
  <div class="container relative z-20 px-6 py-24 mx-auto lg:px-12 md:py-32">
    <div class="flex flex-col items-center justify-between gap-10 md:flex-row">
      ...
      <div class="w-full mb-10 md:w-1/2 md:mb-0
        ...
        <p class="max-w-lg mb-8 text-lg text-black/80 dark:text-slate-300">
        ...
        <div class="flex flex-col gap-4 sm:flex-row">
          ...
          >
            ...
            <svg class="inline-block w-5 h-5 ml-2 transition-transform group-hover:translate-x-1"
